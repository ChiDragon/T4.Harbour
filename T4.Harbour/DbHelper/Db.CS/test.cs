...
namespace T4.SS
{
    ...
    public class MySqlDbHelper : BaseDbHelper
    {
        ...
        {
            #region SQL
            string sql = string.Format(@"SELECT a.TABLE_SCHEMA schemname,a.TABLE_NAME tablename,a.TABLE_ROWS rows,!ISNULL(b.HasPrimaryKey) HasPrimaryKey
                        FROM `TABLES` AS a
                        LEFT JOIN (
                        ...
                        WHERE a.TABLE_SCHEMA = '{0}'", Config.DbDatabase); 
            #endregion
        ...
        public override List<DbColumn> GetDbColumns(string tableName, string schema = "dbo")
        {
            ...
            string sql = string.Format(@"SELECT ORDINAL_POSITION  ColumnID,COLUMN_KEY='PRI' IsPrimaryKey,COLUMN_NAME ColumnName,
                                ...
                                COLUMN_COMMENT Remark FROM `COLUMNS` 
